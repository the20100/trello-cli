...
// update self-updates the trello-cli binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/trello-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update trello-cli to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "trello-cli-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "trello-cli")
